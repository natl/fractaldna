...
if __name__ == "__main__":
    ...
    dnablender.make_render(os.path.join(the_path, "hilbert2.blend"),
                           [750, 750, -3000], [-180, 0, 0],
                           os.path.join(the_path, "hilbert2.png"), clip=15000)
    dnablender.make_movie(os.path.join(the_path, "hilbert2.blend"),
                          [750, 750, 750],
                          2500,
